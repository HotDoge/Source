...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The HotDoge Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "HotDoge Core"
...
#define PACKAGE_NAME "HotDoge Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "HotDoge Core 0.21.3"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "hotdoge"
