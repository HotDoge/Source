...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " hotdoge-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  hotdoge-tx [options] <hex-tx> [commands]  Update hex-encoded hotdoge transaction\n" +
            "or:     hotdoge-tx [options] -create [commands]   Create hex-encoded hotdoge transaction\n" +
            "\n";
