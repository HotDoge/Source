...
const char * const BITCOIN_CONF_FILENAME = "hotdoge.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "HotDoge";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/HotDoge";
#else
    // Unix-like
    return pathRet / ".hotdoge";
#endif
#endif
}
