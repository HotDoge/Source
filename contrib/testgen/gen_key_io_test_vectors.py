...
bech32_templates = [
  ...
  ('hdog',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('hdog',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('hdog',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('hdog',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('thdog',    0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('thdog',    0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('thdog',    1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('thdog',    3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('thdog',    0, 20, (False, 'signet',  None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('thdog',    0, 32, (False, 'signet',  None, True), Encoding.BECH32,  p2wsh_prefix),
  ('thdog',    1, 32, (False, 'signet',  None, True), Encoding.BECH32M, p2tr_prefix),
  ('thdog',    3, 32, (False, 'signet',  None, True), Encoding.BECH32M, (OP_3, 32)),
  ('rhdog',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('rhdog',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('rhdog',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('rhdog', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
...
bech32_ng_templates = [
  ...
  ('thdog',   17, 32, Encoding.BECH32M, False, False, False),
  ('rhdog',  3,  1, Encoding.BECH32M, False, False, False),
  ('hdog',   15, 41, Encoding.BECH32M, False, False, False),
  ('thdog',    0, 16, Encoding.BECH32,  False, False, False),
  ('rhdog',  0, 32, Encoding.BECH32,  True,  False, False),
  ('hdog',    0, 16, Encoding.BECH32,  True,  False, False),
  ('thdog',    0, 32, Encoding.BECH32,  False, True,  False),
  ('rhdog',  0, 20, Encoding.BECH32,  False, False, True),
  ('hdog',    0, 20, Encoding.BECH32M, False, False, False),
  ('thdog',    0, 32, Encoding.BECH32M, False, False, False),
  ('rhdog',  0, 20, Encoding.BECH32M, False, False, False),
  ('hdog',    1, 32, Encoding.BECH32,  False, False, False),
  ('thdog',    2, 16, Encoding.BECH32,  False, False, False),
  ('rhdog', 16, 20, Encoding.BECH32,  False, False, False),
]
