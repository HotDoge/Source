Contributing to HotDoge Core
============================

The HotDoge Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the HotDoge Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/hotdoge-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to hotdoge-qt
...
The following applies to code changes to the HotDoge Core project (and related
projects such as libsecp256k1), and is not to be confused with overall HotDoge
Network Protocol consensus changes.

Whether a pull request is merged into HotDoge Core rests with the project merge
...
Patches that change HotDoge consensus rules are considerably more involved than
...
Where a patch set proposes to change the HotDoge consensus, it must have been
...
The project leader is the release manager for each HotDoge Core release.
