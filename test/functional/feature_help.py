...
"""Verify that starting hotdoge with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start hotdoge with -h for help text")
        ...
        self.log.info("Start hotdoge with -version for version information")
        ...
        self.log.info("Start hotdoged with -fakearg to make sure it does not start")
