# Support for Output Descriptors in HotDoge Core

Since HotDoge Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `hdog1...` for mainnet or `thdog1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
existing HotDoge Core wallets, a convenience function `combo` is
